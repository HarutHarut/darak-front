            ...
            <b-row class="justify-content-center">
                <b-col lg="6">
                    <div class="base-card card mb-3">
                        <div class="card-body">
                            <a :href="'/pdf/Questions texts_' + $i18n.locale + '.pdf'" target="_blank" class="pdf-link">{{
                                $t("dashboard.title.howToUse") }}</a>
                          ...
                          <img v-else :src="require('@/assets/img/upload.png')" alt=""/>
                                                    ...
                                                    <span v-b-tooltip.hover
                                                          :title="$t('dashboard.tooltip.uploadWallpaper')" class="ml-2">
                            ...
                            <svg-icon class="base-icon" name="question-mark"></svg-icon>
                                        ...
                                        <b-col sm="3">
                                            <b-form-group class="d-flex mb-0 mt-2">
                                                ...
                                                <span v-b-tooltip.hover :title="$t('dashboard.tooltip.status')"
                                                      class="ml-2">
                              <svg-icon class="base-icon" name="question-mark"></svg-icon>
                        </span>
                                        ...
                                        <b-col sm="3">
                                            <b-form-group class="d-flex mb-0 mt-2">
                                                ...
                                                <span v-b-tooltip.hover :title="$t('dashboard.tooltip.cardPayment')"
                                                      class="ml-2">
                              <svg-icon class="base-icon" name="question-mark"></svg-icon>
                        </span>
                                            </b-form-group>
                                        ...
                                        <b-col lg="3" sm="12">
                                            <b-form-group class="d-flex mb-0 mt-2">
                                                ...
                                                <span v-b-tooltip.hover :title="$t('dashboard.tooltip.isBookable')"
                                                      class="ml-2">
                              <svg-icon class="base-icon" name="question-mark"></svg-icon>
                        </span>
                                            </b-form-group>
                                        ...
                                        Let’s make sure locker available
        ...
        async asyncData({$axios, route}) {
            ...
            if (data.branch.media.length) {
                data.branch.media.forEach(item => {
                    let def = 0;
                    if (data.branch.preview && data.branch.preview == item.url) {
                        def = 1;
                    }

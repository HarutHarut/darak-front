...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML Sitemap</h2>
		<p class="expl">Generated by <a href="https://www.xsoft.am" target="_blank" title="Sitemap generator for LugLockers">X-Soft</a>. This is styled xml sitemap, sorted by update date.</p>
